...
def litCricFriend(wordList, text):
    ...
    newListedAndLowerCasedEverything = newLowerCasedEverything.split()
    ...
    # Three lines of code.
    newWordList=[]
    for i in newListedAndLowerCasedEverything:
        newWordList.append(i.strip(string.punctuation))
    ...
    counter =0
    for x in wordList:
        counter+=newWordList.count(x.lower())
...
'''
Yes, the results show that Poe and Neruda use 'a' and 'an' differently. For Poe's poem, 
the frequency is {} and the frequency for Neruda's poem is {}.
The results show that Poe and Neruda use 'the' differently. For Poe's poem, the frequency
is {} and the frequency for Neruda's poem is {}.
'''.format(litCricFriend(['A','An'], theBells),litCricFriend(['A','An'], cantoXII), 
           litCricFriend(['The'], theBells),litCricFriend(['The'], cantoXII))
